...
class FlagContainer(models.Model):
    ...
    title = models.CharField(null=False, max_length=40, default="未命名")
    description = models.CharField(null=False, max_length=400, default="没有描述~")
    start_time = models.CharField(null=False, max_length=40)
    total_days = models.IntegerField(null=False)
    finished_days = models.IntegerField(null=False)
    ...
    def get_flag_container(self):
        return {
            ...
            'finishedDays': self.finished_days,
        }
