...
import 'package:knowledge_manager/common/net/graphql/repositories.dart';
import 'package:knowledge_manager/common/net/graphql/users.dart';

GraphQLClient _client(token) {
  final HttpLink _httpLink = HttpLink(
    uri: 'https://api.github.com/graphql', // 这个地址干什么的？？
  );
